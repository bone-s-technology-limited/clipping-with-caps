...
CAPS.Simulation.prototype = {
	...
	init: function () {
		...
		loader.load( './models/model1.stl.dae', function ( collada ) {
		...
		loader.load( './models/model3.stl.dae', function ( collada ) {
			self.initScene3( collada.scene );
		} );
		...
		this.camera = new THREE.PerspectiveCamera( 5, window.innerWidth / window.innerHeight, 1, 200 );
		...
		//this.capsScene.add( this.selection.boxMesh3 );
